package com.evervc.saznexpressstaff.ui.waiter;
...
public class WaiterHomeActivity extends AppCompatActivity {
    private BottomNavigationView bottomNavigationW;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationW.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            @Override
    ...
    private void asociarElementosXML() {
        bottomNavigationW = findViewById(R.id.bottomNavigationW);
    }
    ...
    private void cambiarFragmento(Fragment fragment) {
        getSupportFragmentManager().beginTransaction().replace(R.id.fcvMesero, fragment).commit();
    }
